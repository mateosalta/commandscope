...
void Preview::run(sc::PreviewReplyProxy const& reply) {
    ...
    layout1col.add_column( {  "header_widget", "actions", "summary_widget", } );

    // Two column layout
    layout2col.add_column( {  } );
    layout2col.add_column( { "header_widget", "actions", "summary_widget",  } );

    // Three cokumn layout
    layout3col.add_column( { });
    layout3col.add_column( { "header_widget", "actions", "summary_widget" } );
    layout3col.add_column( { } );
